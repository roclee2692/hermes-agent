---
title: "Cross Platform Porting — Orchestrate evidence-backed cross-platform repository ports"
sidebar_label: "Cross Platform Porting"
...
Orchestrate evidence-backed cross-platform repository ports.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/migration/cross-platform-porting` |
| Path | `optional-skills/migration/cross-platform-porting` |
| Version | `0.1.0` |
| Author | Raelon Veritas Lee (roclee2692), Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `Migration`, `Portability`, `CI`, `Verification`, `GitHub` |
| Related skills | [`github-pr-workflow`](/docs/user-guide/skills/bundled/github/github-github-pr-workflow), [`systematic-debugging`](/docs/user-guide/skills/bundled/software-development/software-development-systematic-debugging) |
